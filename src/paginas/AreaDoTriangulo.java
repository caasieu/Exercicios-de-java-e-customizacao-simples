...
public class AreaDoTriangulo  extends JPanel {
    ...
    public AreaDoTriangulo(String label, Dimension size, CardLayout cardLayout, JPanel mainPanel) {
        ...
        base = new  CustomTextField("Valor da base do triangulo?");
        base.setPreferredSize(new Dimension(250, 50));
        altura = new  CustomTextField("Valor da altura do triangulo?");
