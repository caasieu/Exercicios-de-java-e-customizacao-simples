...
public class Salario  extends JPanel {
    ...
    public Salario(String label, Dimension size, CardLayout cardLayout, JPanel mainPanel) {
        ...
        salario = new  CustomTextField("Qual e o salario actual?");
    ...
    private double calculo(double salario){
        double percentagem =  (salario / 100) * 25;
